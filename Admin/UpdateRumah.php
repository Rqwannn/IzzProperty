...
$nama = $getSingle['nama_pemilik'];
$email = $getSingle['email'];
$telepon = $getSingle['telepon'];
$tipe = $getSingle['tipe'];
$luas_tanah = $getSingle['luas_tanah'];
$kamar_mandi = $getSingle['kamar_mandi'];
$fasilitas = $getSingle['fasilitas'];
$sertifikat = $getSingle['sertifikasi'];
$luas_bangunan = $getSingle['luas_bangunan'];
$kamar_tidur = $getSingle['kamar_tidur'];
$lantai = $getSingle['lantai'];
$carport_garasi = $getSingle['carport_garasi'];
$alamat = $getSingle['alamat'];
$harga = $getSingle['harga'];
$kota = $getSingle['kota'];
$provinsi = $getSingle['provinsi'];
$maps = $getSingle['maps'];
$deskripsi = $getSingle['deskripsi'];
$kode_pos = $getSingle['kode_pos'];
$gambar = $getSingle['gambar'];
                    ...
                    <div class="col-md-12 mt-5">
                        <div class="cardProfileAdmin">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="inputAdmin d-flex flex-column">
                                                ...
                                                <input type="text" name="nama" value="<?php echo $nama ?>" id="nama" class="form-control mt-2">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="inputAdmin d-flex flex-column">
                                                <label for="telepon" class="text-secondary">No. Telepon</label>
                                                <input type="text" name="telepon" value="<?php echo $telepon ?>" id="telepon" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control mt-2">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-3">
                                            <div class="inputAdmin d-flex flex-column">
                                                <label for="email" class="text-secondary">Email</label>
                                                <input type="email" name="email" value="<?php echo $email ?>" id="email" class="form-control mt-2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="contentEmploye mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="inputAdmin d-flex flex-column">
                                                    ...
                                                    <input type="text" name="tipeRumah" value="<?php echo $tipe ?>" id="tipeRumah" class="form-control mt-2">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="luasTanah" class="text-secondary">Luas Tanah</label>
                                                    <input type="text" name="luasTanah" value="<?php echo $luas_tanah ?>" id="luasTanah" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="kamarMandi" class="text-secondary">Jml Kamar Mandi</label>
                                                    <input type="text" name="kamarMandi" value="<?php echo $kamar_mandi ?>" id="kamarMandi" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="Fasilitas" class="text-secondary">Fasilitas</label>
                                                    <input type="text" name="Fasilitas" value="<?php echo $fasilitas ?>" id="Fasilitas" class="form-control mt-2">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="luasBangunan" class="text-secondary">Luas Bangunan</label>
                                                    <input type="text" name="luasBangunan" value="<?php echo $luas_bangunan ?>" id="luasBangunan" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="kamarTidur" class="text-secondary">Jml Kamar Tidur</label>
                                                    <input type="text" name="kamarTidur" value="<?php echo $kamar_tidur ?>" id="kamarTidur" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="lantai" class="text-secondary">Jumlah Lantai</label>
                                                    <input type="text" name="lantai" value="<?php echo $lantai ?>" id="lantai" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin mt-3 d-flex flex-column">
                                                    <label for="carpotGarasi" class="text-secondary">Carpot Garasi</label>
                                                    <input type="text" name="carpotGarasi" value="<?php echo $carport_garasi ?>" id="carpotGarasi" class="form-control mt-2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="inputAdmin d-flex flex-column">
                                                    ...
                                                    <input type="text" name="alamat" value="<?php echo $alamat ?>" id="alamat" class="form-control mt-2">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="kota" class="text-secondary">Kota</label>
                                                    <input type="hidden" value="<?php echo $kota ?>" id="setKota">
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <div class="inputAdmin d-flex flex-column">
                                                    ...
                                                    <input type="text" name="provinsi" value="<?php echo $provinsi ?>" id="provinsi" class="form-control mt-2">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="kodePos" class="text-secondary">Kode Pos</label>
                                                    <input type="text" name="kodePos" value="<?php echo $kode_pos ?>" id="kodePos" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="maps" class="text-secondary">Link Maps</label>
                                                    <input type="text" name="maps" value="<?php echo $maps ?>" id="maps" class="form-control mt-2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="inputAdmin d-flex flex-column">
                                                    ...
                                                    <input type="text" value="<?php echo $harga ?>" name="harga" id="harga" class="form-control mt-2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="sertifikat" class="text-secondary">Sertifikat</label>
                                                    <input type="text" name="sertifikat" value="<?php echo $sertifikat ?>" id="sertifikat" class="form-control mt-2">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                                <div class="inputAdmin d-flex flex-column">
                                                    <label for="deskripsi" class="text-secondary">Deskripsi</label>
                                                    <textarea type="text" name="deskripsi" id="deskripsi" class="form-control mt-2"><?php echo $deskripsi ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="inputAdmin d-flex flex-column">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="hidden" value="<?php echo $gambar ?>" id="oldGambar">
                                ...
                                <div class="container">
                                    <div class="titleContent">
                                        <p class="my-5">Gambar Lama</p>
                                        <div class="lineTitleAdmin"></div>
                                    </div>
                                </div>
                                <div class="contentProfileAdmin">
                                    <div class="container">
                                        <div class="row WrapperOldGambar">
                                ...
                                <div class="col-md-6">
                                    <div class="container">
                                        <div class="btnContent-profile mt-4">
                                            <button type="submit" onclick="UpdateDataRumah(<?php echo $id ?>)" class="btn btnUpdate-Profile mb-3">Update Rumah</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
