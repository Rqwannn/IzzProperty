...
<head>
    ...
    <title>Data Admin | IzzProperty</title>
                    ...
                    <div class="contentSide">
                        <div class="container">
                            ...
                            <ul class="sideNav-link activeBG mt-2">
                                <li>
                                    <a class="nav-link activeColor" href="TotalAdmin.php">
                                        <p><i class="far fa-copy" style="color: #fff;"></i>Total Admin</p>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="navbarRight">
                        <div class="MoreProfile">
                            <div class="clickValueProfile d-flex">
                                <img src="../Img/profile.png" class="rounded-circle clickBtnProfile">
